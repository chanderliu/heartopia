...
const translatedText = computed(() => {
  if (props.item.text) {
    return i18n.tText(props.item.text)
  }
  return ''
})
  ...
  <component :is="sectionTag" class="VPSidebarItem" :class="classes">
    ...
    >
      ...
      <VPLink
        ...
        :target="item.target"
      >
        <component :is="textTag" class="text">{{ translatedText }}</component>
      </VPLink>
      <component v-else :is="textTag" class="text">{{ translatedText }}</component>
